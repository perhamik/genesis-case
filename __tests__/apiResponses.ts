import type {AuthResponseData, CourseSingleType, CoursesResponseData} from '@/src/shared/api'

export const authResponse: AuthResponseData = {
	token: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIzNmZlMDc2ZC04Mzc3LTQ0MWQtYWVhNi1iOGM3MmFhM2M0ZmEiLCJwbGF0Zm9ybSI6InN1YnNjcmlwdGlvbnMiLCJpYXQiOjE2ODM3MTQ5NzksImV4cCI6MTY4MzcxNTg3OX0.B06s8_L-_qSRdz-KRs7Q2u8qqxmAmqmdSsRHQmaIIY8',
}

export const singleCourse: CourseSingleType = {
...
export const coursesList: CoursesResponseData = {
	courses: [
		{
			id: '352be3c6-848b-4c19-9e7d-54fe68fef183',
			title: 'Lack of Motivation & How to Overcome It',
		...
		},
		{
			...
			meta: {
				...
				skills: ['Task management', 'Scheduling 100%', 'Prioritizing', 'Delegating'],
				courseVideoPreview: {
